...
<div class="col-md-3 side-col border-success">
    <div class="card w-100 profile-card border-0 card-body animate__animated animate__fadeLeft " style="border: 1px solid green!important;">
        ...
        <ul class="nav nav-pills-primary-soft flex-column ">
            <li class="nav-item">
                <a class="nav-link {{ Request::is('pricelist') || Request::segment(1) == 'pricelist' ? 'active' : '' }}" href="{{route('priceList')}}"><i class="fa-solid fa-list me-2"></i><span>{{ __('message.price_list') }}</span></a>
            </li>
            <li class="nav-item">
